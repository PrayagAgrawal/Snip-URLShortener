...
**Shorten. Track. Secure. Scale.**

Linklytics is a backend service that allows users to create short URLs, track engagement through analytics, and securely manage their links using JWT-based authentication.
