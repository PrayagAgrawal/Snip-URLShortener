...
public class UserService {
    ...
    public User registerUser(User user) {
        System.out.println("--- REGISTER SERVICE: Original password: " + user.getPassword());
        String encodedPassword = passwordEncoder.encode(user.getPassword());
        System.out.println("--- REGISTER SERVICE: ENCODED password: " + encodedPassword); // <-- ADD THIS LINE
